...
public class Viewgame1hard extends View implements IModelListener{
    private TargetModel model;
    private Controllergame1hard controller;
    private Handler h;
    private long delay = 200;
    private long delay2 = 500;

    public Viewgame1hard(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public void setMVC(TargetModel md, Controllergame1hard ct) {
        this.model = md;
        this.controller = ct;
    ...
    public void popup() {
        ...
        adInfo.setPositiveButton("sure", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                System.out.println("a"+model.getScore());
